const generateHTML = (pageName) => {
  ...
  <div class="text">
    ...
    <div class='_2'>STUDYING BACK-OFF> ${pageName}</div>
  </div>

  <div class="astronaut">
    <img src="https://images.vexels.com/media/users/3/242550/isolated/preview/b76a2dcee70dde5c55b4b6688d42a4f1-boy-with-grades-semi-flat.png" alt="" class="src">
  </div>
  `;
  };
  ...
  switch (window.location.hostname){
    ...
    case "dev.to":
      document.head.innerHTML = generateSTYLING();
      document.body.innerHTML = generateHTML('DEV-TO');
      break; 
    case "daily.dev":
      document.head.innerHTML = generateSTYLING();
      document.body.innerHTML = generateHTML('DAILY DEV');
  };